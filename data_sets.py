...
BOSTON_COL_DESC = {
    ...
    "MEDV": "Median value of owner-occupied homes in $1000's", # This is the target value
}


def loadFrenchMotorData():
    ...
    return df, df["ClaimNb"]/df["Exposure"]
...
def loadBostonData():
    ...
    colNames = BOSTON_COL_DESC.keys()
    df = pd.read_csv("datasets/housing.csv", names=colNames)
